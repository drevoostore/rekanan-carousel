  ...
  <script>
    ...
    function filterCards(query) {
      ...
      if (!q) {
        ...
        // Complete reset of track
        track.style.cssText = 'display: flex; gap: 15px; padding: 0 55px; transition: transform 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94); will-change: transform; overflow: hidden; flex-wrap: nowrap; flex-direction: row; width: auto; transform: translateX(0px)';
